        ...
        <table class="table table-dark table-striped table-hover d-flex justify-content-center border-secondary rounded ">
            ...
            <?php 
                ...
                if(isset($_POST['btnbuscar'])){
                    ...
                    $queryusuarios = mysqli_query($conn, "SELECT no_,cod,nombre,apellido,ciudad,direccion,telefono,codigo_postal,correo_cliente,contrasena FROM usuario where Nombre like '".$buscar."%'");
                }
                else{
                    $queryusuarios = mysqli_query($conn, "SELECT * FROM usuario ORDER BY no_ asc");
                }
                $numerofila = 0;
