...
$querybuscar = mysqli_query($conn, "SELECT * FROM usuario WHERE cod=$codigo");
...
<?php
    ...
    if(isset($_POST['btnmodificar'])){
        ...
        $querymodificar = mysqli_query($conn, "UPDATE usuario SET nombre='$nombre1',apellido='$apellido1',ciudad='$ciudad1',direccion='$direccion1',telefono='$telefono1',codigo_postal='$codigoPostal1',correo_cliente='$correo1',contrasena='$contrasena1' WHERE cod=$numdoc1");
