...
$querybuscar = mysqli_query($conn, "SELECT * FROM categorias WHERE cod=$codigo");
...
<?php
    ...
    if(isset($_POST['btnmodificar']))
    {
        ...
        $querymodificar = mysqli_query($conn, "UPDATE categorias SET tipo_pro='$tipo_pro2',carac='$carac3' WHERE cod='$codigo1'");
