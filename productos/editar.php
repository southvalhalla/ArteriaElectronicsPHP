...
<?php
    ...
    if(isset($_POST['btnmodificar'])){
        ...
        $querymodificar = mysqli_query($conn, "UPDATE productos SET nom_pro=' $nom_pro2',marca='$marca3',precio=' $precio4',precio=' $precio4',imagenes=' $imagenes5',descripcion='$descripcion7' WHERE cod=$cod1");
