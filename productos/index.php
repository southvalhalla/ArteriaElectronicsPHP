        ...
        <table class="table table-dark table-striped table-hover d-flex justify-content-center border-secondary rounded ">
            ...
            <?php 
                ...
                if(isset($_POST['btnbuscar'])){
                    ...
                    $queryusuarios = mysqli_query($conn, "SELECT no_,cod,nom_pro,id_catego,marca,precio,imagenes,fecha_fab,descripcion FROM productos where nom_pro like '".$buscar."%'");
                }
                else{
                    $queryusuarios = mysqli_query($conn, "SELECT * FROM productos ORDER BY no_ asc");
                }
                $numerofila = 0;
