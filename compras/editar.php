...
$querybuscar = mysqli_query($conn, "SELECT * FROM compras WHERE cod=$codigo");
...
<?php
    ...
    if(isset($_POST['btnmodificar'])){
        ...
        $querymodificar = mysqli_query($conn, "UPDATE compras SET fecha='$fecha1',estadoPedido='$estado1',metodoPago='$metodo1',precioTotal='$precio1' WHERE cod=$cod1");
